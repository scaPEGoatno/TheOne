...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements com.handmark.pulltorefresh.library.IPullToRefresh<T> {
	...
	private com.handmark.pulltorefresh.library.internal.LoadingLayout mHeaderLayout;
	private com.handmark.pulltorefresh.library.internal.LoadingLayout mFooterLayout;
	...
	@Override
	public final com.handmark.pulltorefresh.library.ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean includeEnd) {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
				&& com.handmark.pulltorefresh.library.OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	}
	...
	protected com.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		com.handmark.pulltorefresh.library.internal.LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	 ...
	 */
	protected com.handmark.pulltorefresh.library.LoadingLayoutProxy createLoadingLayoutProxy(final boolean includeStart, final boolean includeEnd) {
		com.handmark.pulltorefresh.library.LoadingLayoutProxy proxy = new com.handmark.pulltorefresh.library.LoadingLayoutProxy();
	...
	protected final com.handmark.pulltorefresh.library.internal.LoadingLayout getFooterLayout() {
	...
	protected final com.handmark.pulltorefresh.library.internal.LoadingLayout getHeaderLayout() {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			com.handmark.pulltorefresh.library.internal.ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			com.handmark.pulltorefresh.library.internal.Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
	...
	public static enum AnimationStyle {
		...
		com.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new com.handmark.pulltorefresh.library.internal.RotateLoadingLayout(context, mode, scrollDirection, attrs);
				case FLIP:
					return new com.handmark.pulltorefresh.library.internal.FlipLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				com.handmark.pulltorefresh.library.internal.ViewCompat.postOnAnimation(PullToRefreshBase.this, this);
			} else {
				if (null != mListener) {
